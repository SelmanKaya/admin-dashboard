...
<template>
  <div class=" fixed top-0 flex items-center justify-center min-h-screen bg-gray-100">
    <div class=" bg-white p-8 rounded-b-sm shadow-2xl w-full px-4 py-3 flex items-center justify-between max-w-full lg:ml-[250px]">
